  ...
  calculateStats() {
    ...
    const categorizeSnack = (snack: string): string => {
      ...
      const categories: {[key: string]: string[]} = {
        ...
        'Fruit Snacks': ['fruit snack', 'gusher', 'fruit roll', 'fruit rollup', 'welch fruit snack', 'gummy', 'gummies', 'sour gummy', 'gummy worm', 'gummy bear', 'frogeroni'],
        ...
        'Gum': ['chewing gum', 'bubblegum', 'bubble gum', 'gum pack', 'stick of gum', 'trident', 'orbit', 'extra gum'],
